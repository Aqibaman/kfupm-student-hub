...
export function EmergencyTimeline({ currentStage }: { currentStage: EmergencyStage }) {
  return (
    <div className="overflow-x-auto rounded-[30px] border border-brand-100/70 bg-[radial-gradient(circle_at_top_left,_rgba(107,255,205,0.16),_transparent_22%),radial-gradient(circle_at_top,_rgba(255,214,102,0.14),_transparent_28%),linear-gradient(180deg,#ffffff_0%,#f7faf9_100%)] p-5 shadow-[0_24px_50px_rgba(15,66,55,0.08)]">
      <div className="grid min-w-[900px] grid-cols-5 gap-3">
        {emergencyStages.map((step, index) => {
          ...
          return (
            <div key={step} className={`relative flex flex-col items-center rounded-[24px] px-2 py-3 text-center ${panelGlow}`}>
